...
cAPI.clothingSystemPushRequest =  clothingSystemPushRequest
...
function HANDLER_REMOVE_CURRENT_APPARATUS_BY_TYPE(pedId, data)
    ...
    local shopItemCategory = exports.frp_lib:camelToSnakeCase(eMetapedBodyApparatusTypeToStr[apparatusType]);
...
function HANDLER_UPDATE_CURRENT_APPARATUS(ped, data)
    ...
    if data.useTempPath then
        ...
        local function findShopItemByApparatusType()
            ...
            local rdr3ShopItemCategory = exports.frp_lib:camelToSnakeCase(eMetapedBodyApparatusTypeToStr[apparatusType]);      
