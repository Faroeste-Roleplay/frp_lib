...
cAPI.handleStartEditor = handleStartEditor
...
function requestChangeApparatus(ped, request)
    ...
    local apparatusTypeName = exports.frp_lib:snakeToPascal(requestSubtype:gsub('_COLOR', ''))
...
cAPI.requestChangeApparatus = requestChangeApparatus
